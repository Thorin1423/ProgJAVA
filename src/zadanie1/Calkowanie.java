...
public class Calkowanie {
    ...
    public static void main(String[] args) {
        ...
        Calkowanie kalkulator = new Calkowanie();  //tworzymy obiekt i wywolujemy metode
        double wynik = kalkulator.obliczKwadratowe(a,b,c,x1,x2); // dane testowe 0,0,5,0,2 wynik=10 // 3,2,1,0,1 wynik=3
